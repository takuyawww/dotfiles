...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    ...
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["fern-git-status.vim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/fern-git-status.vim",
    url = "https://github.com/lambdalisue/fern-git-status.vim"
  },
  ["fern-renderer-nerdfont.vim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/fern-renderer-nerdfont.vim",
    url = "https://github.com/lambdalisue/fern-renderer-nerdfont.vim"
  },
  ["fern.vim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/fern.vim",
  ...
  indentLine = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/indentLine",
    url = "https://github.com/Yggdroot/indentLine"
  },
  ["lexima.vim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/lexima.vim",
    url = "https://github.com/cohama/lexima.vim"
  },
  ["lightline.vim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/lightline.vim",
  ...
  ["nerdfont.vim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/nerdfont.vim",
  ...
  ["tender.vim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/tender.vim",
